...
def multi_thread_run(config='_sarResNet50_g1_blConfig', 
    ...
    train_url = f'{train_url_base}_bifuse_mask1_g{patch_groups}_ls{ls}_amp{use_amp}_warmup{wmup}/'
...
config1 = f'_sarResNet50_bifuse_mask1_g{args.patch_groups1}_blConfig'
config2 = f'_sarResNet50_bifuse_mask1_g{args.patch_groups2}_blConfig'
