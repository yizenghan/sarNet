...
def multi_thread_run(config='_sarResNet50_g1_blConfig', 
    ...
    train_url = f'{train_url_base}width{wd}_g{patch_groups}_alpha{alpha}_t0_{str_t0}_target{ta_str[-1]}_ls{ls}_amp{use_amp}_warmup{wmup}_dynamicRate{dynamic_rate}/'    
...
config1 = f'_sarResNet50_bifuse_g{args.patch_groups1}_blConfig'
config2 = f'_sarResNet50_bifuse_g{args.patch_groups2}_blConfig'
