...
def inception_v3(num_classes=1000, pretrained=False, progress=True, dropout=0.0, **kwargs):
    ...
    return Inception3(num_classes, dropout=dropout, **kwargs)


class Inception3(nn.Module):

    def __init__(self, num_classes=1000, aux_logits=True, transform_input=False,
                 inception_blocks=None, init_weights=None, dropout=0.0):
