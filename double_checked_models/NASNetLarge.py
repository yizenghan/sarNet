...
def nasnetalarge(num_classes, pretrained=False, dropout=0.0):
    ...
    if pretrained:
        ...
        model = NASNetALarge(num_classes=1001, dropout=dropout)
        ...
        model = NASNetALarge(num_classes=num_classes, dropout=dropout)
    return model
