...
def inceptionresnetv2(num_classes=1000, pretrained=False, dropout=0.0):
    ...
    if pretrained:
        ...
        model = InceptionResNetV2(num_classes=1001, dropout=dropout)
        ...
        model = InceptionResNetV2(num_classes, dropout)
    return model
