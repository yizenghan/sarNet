...
def resnet18(num_classes, pretrained=False, progress=True, dropout=0.0, **kwargs):
...
def resnet34(num_classes, pretrained=False, progress=True, dropout=0.0, **kwargs):
...
def resnet50(num_classes, pretrained=False, progress=True, dropout=0.0, **kwargs):
...
def resnet101(num_classes, pretrained=False, progress=True, dropout=0.0, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(num_classes, 'resnet101', Bottleneck, [3, 4, 23, 3], pretrained, progress,
                   dropout=dropout, **kwargs)



def resnet152(num_classes, pretrained=False, progress=True, dropout=0.0, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(num_classes, 'resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress,
                   dropout=dropout, **kwargs)
