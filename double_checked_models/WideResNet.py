...
def wide_resnet50_2(num_classes, pretrained=False, progress=True, dropout=0.0, **kwargs):
    ...
    return _resnet(num_classes, 'wide_resnet50_2', Bottleneck, [3, 4, 6, 3], pretrained, progress,
                   dropout=dropout, **kwargs)



def wide_resnet101_2(num_classes, pretrained=False, progress=True, dropout=0.0, **kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _resnet(num_classes, 'wide_resnet101_2', Bottleneck, [3, 4, 23, 3], pretrained, progress,
                   dropout=dropout, **kwargs)
