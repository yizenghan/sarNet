...
def dpn68(pretrained=False, test_time_pool=False, dropout=0.0, **kwargs):
    ...
    model = DPN(
        ...
        test_time_pool=test_time_pool, dropout=dropout, **kwargs)
    if pretrained:
        model.load_state_dict(load_state_dict_from_url(model_urls['dpn68']))
    return model


def dpn68b(pretrained=False, test_time_pool=False, dropout=0.0, **kwargs):
...
def dpn92(pretrained=False, test_time_pool=False, dropout=0.0, **kwargs):
...
def dpn98(pretrained=False, test_time_pool=False, dropout=0.0, **kwargs):
...
def dpn107(pretrained=False, test_time_pool=False, dropout=0.0, **kwargs):
...
def dpn131(pretrained=False, test_time_pool=False, dropout=0.0, **kwargs):
...
class DPN(nn.Module):
    def __init__(self, small=False, num_init_features=64, k_r=96, groups=32,
                 ...
                 num_classes=1000, test_time_pool=False, dropout=0.0):
