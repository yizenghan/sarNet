...
def googlenet(num_classes=1000, pretrained=False, progress=True, dropout=0.0, **kwargs):
    ...
    return GoogLeNet(num_classes, dropout=dropout, **kwargs)
...
class GoogLeNet(nn.Module):
    ...
    def _transform_input(self, x): # normalize
        # type: (Tensor) -> Tensor
