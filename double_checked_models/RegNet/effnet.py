...
"""EfficientNet_Pytorch models."""

import double_checked_models.RegNet.core.net as net
import torch
...
class EffHead(nn.Module):
    """EfficientNet_Pytorch head: 1x1, BN, Swish, AvgPool, Dropout, FC."""
...
class MBConv(nn.Module):
    ...
    def __init__(self, w_in, exp_r, kernel, stride, se_r, w_out):
        ...
        self.se = SE(w_exp, int(w_in * se_r)) if se_r > 0.0 else None
...
class StemIN(nn.Module):
    """EfficientNet_Pytorch stem for ImageNet: 3x3, BN, Swish."""
