...
__all__ = ['blresnet50_a2_b4', 'blresnet152_a2_b4']
...
model_urls = {
    ...
    'blresnet-152-a2-b4': 'pretrained/ImageNet-bLResNet-152-a2-b4.pth.tar',
}
...
class bLResNet(nn.Module):
    ...
    def __init__(self, num_classes,  block, layers, alpha, beta, dropout):
...
def blresnet_model(num_classes, depth=50, alpha=2, beta=4, pretrained=False, dropout=0.0):
    layers = {
        50: [3, 4, 6, 3],
        101: [4, 8, 18, 3],
        152: [5, 12, 30, 3]
    }[depth]
    model = bLResNet(num_classes, Bottleneck, layers, alpha, beta, dropout)
...
def blresnet50_a2_b4(num_classes=1000, pretrained=False, dropout=0.0):
    depth = 50
    layers = [3, 4, 6, 3]
    alpha = 2
    beta = 4
...
def blresnet152_a2_b4(num_classes=1000, pretrained=False, dropout=0.0):
    depth = 152
    alpha = 2
    beta = 4
    layers = [5, 12, 30, 3]
