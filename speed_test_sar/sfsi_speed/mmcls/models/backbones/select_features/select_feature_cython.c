...
#define __PYX_HAVE__select_feature_cython
#define __PYX_HAVE_API__select_feature_cython
/* Early includes */
#include <string.h>
#include "pythread.h"
#include <stdlib.h>
...
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_float__const__(PyObject *, int writable_flag);

/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_int__const__(PyObject *, int writable_flag);
...
/* Module declarations from 'select_feature_cython' */
...
static int __pyx_f_21select_feature_cython__apply_select_features(int, int, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static PyObject *__pyx_f_21select_feature_cython_apply_select_features(__Pyx_memviewslice, __Pyx_memviewslice, int const , __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "select_feature_cython"
extern int __pyx_module_is_main_select_feature_cython;
int __pyx_module_is_main_select_feature_cython = 0;

/* Implementation of 'select_feature_cython' */
...
static PyObject *__pyx_pf_21select_feature_cython_apply_select_features(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_input, __Pyx_memviewslice __pyx_v_offset, int __pyx_v_thread, __Pyx_memviewslice __pyx_v_output); /* proto */
...
static int __pyx_f_21select_feature_cython__apply_select_features(int __pyx_v_th_id, int __pyx_v_num_thread, __Pyx_memviewslice __pyx_v_input, __Pyx_memviewslice __pyx_v_offset, __Pyx_memviewslice __pyx_v_output) {
 ...
 *     n = input.shape[0]
 */
  __pyx_v_NTH = __pyx_v_num_thread;

  /* "select_feature_cython.pyx":15
 *     cdef int NTH, NID
 *     NTH = num_thread
 *     NID = th_id             # <<<<<<<<<<<<<<
 *     n = input.shape[0]
 *     c = input.shape[1]
 */
  __pyx_v_NID = __pyx_v_th_id;

  /* "select_feature_cython.pyx":16
 *     NTH = num_thread
 *     NID = th_id
 *     n = input.shape[0]             # <<<<<<<<<<<<<<
 *     c = input.shape[1]
 *     h = input.shape[2]
 */
  __pyx_v_n = (__pyx_v_input.shape[0]);

  /* "select_feature_cython.pyx":17
 *     NID = th_id
 *     n = input.shape[0]
 *     c = input.shape[1]             # <<<<<<<<<<<<<<
 *     h = input.shape[2]
 *     w = input.shape[3]
 */
  __pyx_v_c = (__pyx_v_input.shape[1]);

  /* "select_feature_cython.pyx":18
 *     n = input.shape[0]
 *     c = input.shape[1]
 *     h = input.shape[2]             # <<<<<<<<<<<<<<
 *     w = input.shape[3]
 * 
 */
  __pyx_v_h = (__pyx_v_input.shape[2]);

  /* "select_feature_cython.pyx":19
 *     c = input.shape[1]
 *     h = input.shape[2]
 *     w = input.shape[3]             # <<<<<<<<<<<<<<
 * 
 *     oh = offset.shape[1]
 */
  __pyx_v_w = (__pyx_v_input.shape[3]);

  /* "select_feature_cython.pyx":21
 *     w = input.shape[3]
 * 
 *     oh = offset.shape[1]             # <<<<<<<<<<<<<<
 *     ow = offset.shape[2]
 *     for _c in range(c):
 */
  __pyx_v_oh = (__pyx_v_offset.shape[1]);

  /* "select_feature_cython.pyx":22
 * 
 *     oh = offset.shape[1]
 *     ow = offset.shape[2]             # <<<<<<<<<<<<<<
 *     for _c in range(c):
 *         if _c % NTH != NID:
 */
  __pyx_v_ow = (__pyx_v_offset.shape[2]);

  /* "select_feature_cython.pyx":23
 *     oh = offset.shape[1]
 *     ow = offset.shape[2]
 *     for _c in range(c):             # <<<<<<<<<<<<<<
 *         if _c % NTH != NID:
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v__c = __pyx_t_3;

    /* "select_feature_cython.pyx":24
 *     ow = offset.shape[2]
 *     for _c in range(c):
 *         if _c % NTH != NID:             # <<<<<<<<<<<<<<
 *             continue
 * 
 */
    __pyx_t_4 = (((__pyx_v__c % __pyx_v_NTH) != __pyx_v_NID) != 0);
    if (__pyx_t_4) {

      /* "select_feature_cython.pyx":25
 *     for _c in range(c):
 *         if _c % NTH != NID:
 *             continue             # <<<<<<<<<<<<<<
 * 
 ...
 *                 _x = offset[0, _i, _j, 1]
 */
    __pyx_t_5 = __pyx_v_oh;
    __pyx_t_6 = __pyx_t_5;
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      __pyx_v__i = __pyx_t_7;

      /* "select_feature_cython.pyx":28
 * 
 *         for _i in range(oh):
 *             for _j in range(ow):             # <<<<<<<<<<<<<<
 *                 _x = offset[0, _i, _j, 1]
 *                 _y = offset[0, _i, _j, 0]
 */
      __pyx_t_8 = __pyx_v_ow;
      __pyx_t_9 = __pyx_t_8;
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        __pyx_v__j = __pyx_t_10;

        /* "select_feature_cython.pyx":29
 *         for _i in range(oh):
 *             for _j in range(ow):
 *                 _x = offset[0, _i, _j, 1]             # <<<<<<<<<<<<<<
 *                 _y = offset[0, _i, _j, 0]
 ...
 */
        ...
        __pyx_t_13 = __pyx_v__j;
        __pyx_t_14 = 1;
        __pyx_v__x = (*((int const  *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_offset.data + __pyx_t_11 * __pyx_v_offset.strides[0]) ) + __pyx_t_12 * __pyx_v_offset.strides[1]) ) + __pyx_t_13 * __pyx_v_offset.strides[2]) ) + __pyx_t_14 * __pyx_v_offset.strides[3]) )));

        /* "select_feature_cython.pyx":30
 *             for _j in range(ow):
 *                 _x = offset[0, _i, _j, 1]
 *                 _y = offset[0, _i, _j, 0]             # <<<<<<<<<<<<<<
 *                 if(_x >= 0 and _x < w and _y >= 0 and _y < h):
 ...
 */
        ...
        __pyx_t_18 = 0;
        __pyx_v__y = (*((int const  *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_offset.data + __pyx_t_15 * __pyx_v_offset.strides[0]) ) + __pyx_t_16 * __pyx_v_offset.strides[1]) ) + __pyx_t_17 * __pyx_v_offset.strides[2]) ) + __pyx_t_18 * __pyx_v_offset.strides[3]) )));

        /* "select_feature_cython.pyx":31
 *                 _x = offset[0, _i, _j, 1]
 *                 _y = offset[0, _i, _j, 0]
 *                 if(_x >= 0 and _x < w and _y >= 0 and _y < h):             # <<<<<<<<<<<<<<
 *                         output[0, _c, _i, _j] = input[0, _c, _y, _x]
 * 
 */
        __pyx_t_19 = ((__pyx_v__x >= 0) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_4 = __pyx_t_19;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_19 = ((__pyx_v__x < __pyx_v_w) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_4 = __pyx_t_19;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_19 = ((__pyx_v__y >= 0) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_4 = __pyx_t_19;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_19 = ((__pyx_v__y < __pyx_v_h) != 0);
        __pyx_t_4 = __pyx_t_19;
        __pyx_L11_bool_binop_done:;
        if (__pyx_t_4) {

          /* "select_feature_cython.pyx":32
 *                 _y = offset[0, _i, _j, 0]
 *                 if(_x >= 0 and _x < w and _y >= 0 and _y < h):
 *                         output[0, _c, _i, _j] = input[0, _c, _y, _x]             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_20 = 0;
          __pyx_t_21 = __pyx_v__c;
          __pyx_t_22 = __pyx_v__y;
          __pyx_t_23 = __pyx_v__x;
          __pyx_t_24 = 0;
          __pyx_t_25 = __pyx_v__c;
          __pyx_t_26 = __pyx_v__i;
          __pyx_t_27 = __pyx_v__j;
          *((float *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_output.data + __pyx_t_24 * __pyx_v_output.strides[0]) ) + __pyx_t_25 * __pyx_v_output.strides[1]) ) + __pyx_t_26 * __pyx_v_output.strides[2]) ) + __pyx_t_27 * __pyx_v_output.strides[3]) )) = (*((float const  *) ( /* dim=3 */ (( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_input.data + __pyx_t_20 * __pyx_v_input.strides[0]) ) + __pyx_t_21 * __pyx_v_input.strides[1]) ) + __pyx_t_22 * __pyx_v_input.strides[2]) ) + __pyx_t_23 * __pyx_v_input.strides[3]) )));
...
static PyObject *__pyx_pw_21select_feature_cython_1apply_select_features(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_21select_feature_cython_apply_select_features(__Pyx_memviewslice __pyx_v_input, __Pyx_memviewslice __pyx_v_offset, int const __pyx_v_thread, __Pyx_memviewslice __pyx_v_output, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_th;
  int __pyx_v__thread;
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("apply_select_features", 0);

  /* "select_feature_cython.pyx":37
 *     cdef int th
 *     cdef int _thread
 *     _thread = thread             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v__thread = __pyx_v_thread;

  /* "select_feature_cython.pyx":38
 *     cdef int _thread
 *     _thread = thread
 *     for th in prange(_thread, num_threads=_thread, nogil=True):             # <<<<<<<<<<<<<<
 *         _apply_select_features(th, _thread, input, offset, output)
 */
  {
      ...
      /*try:*/ {
        ...
        if (1 == 0) abort();
        {
            ...
            {
                #ifdef _OPENMP
                #pragma omp parallel num_threads(__pyx_v__thread)
                #endif /* _OPENMP */
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_th) lastprivate(__pyx_v_th)
                    #endif /* _OPENMP */
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            __pyx_v_th = (int)(0 + 1 * __pyx_t_2);

                            /* "select_feature_cython.pyx":39
 *     _thread = thread
 *     for th in prange(_thread, num_threads=_thread, nogil=True):
 *         _apply_select_features(th, _thread, input, offset, output)             # <<<<<<<<<<<<<<
 */
                            (void)(__pyx_f_21select_feature_cython__apply_select_features(__pyx_v_th, __pyx_v__thread, __pyx_v_input, __pyx_v_offset, __pyx_v_output));
                        }
                    }
                }
            }
...
/* Python wrapper */
static PyObject *__pyx_pw_21select_feature_cython_1apply_select_features(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_21select_feature_cython_1apply_select_features(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("apply_select_features (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_input,&__pyx_n_s_offset,&__pyx_n_s_thread,&__pyx_n_s_output,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_offset)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("apply_select_features", 1, 4, 4, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_thread)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("apply_select_features", 1, 4, 4, 2); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_output)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("apply_select_features", 1, 4, 4, 3); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "apply_select_features") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
    ...
    __pyx_v_input = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_float__const__(values[0], 0); if (unlikely(!__pyx_v_input.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_offset = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_int__const__(values[1], 0); if (unlikely(!__pyx_v_offset.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_thread = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_thread == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_output = __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_float(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_output.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("apply_select_features", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 34, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("select_feature_cython.apply_select_features", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21select_feature_cython_apply_select_features(__pyx_self, __pyx_v_input, __pyx_v_offset, __pyx_v_thread, __pyx_v_output);
...
static PyObject *__pyx_pf_21select_feature_cython_apply_select_features(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_input, __Pyx_memviewslice __pyx_v_offset, int __pyx_v_thread, __Pyx_memviewslice __pyx_v_output) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("apply_select_features", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_input.memview)) { __Pyx_RaiseUnboundLocalError("input"); __PYX_ERR(0, 34, __pyx_L1_error) }
  if (unlikely(!__pyx_v_offset.memview)) { __Pyx_RaiseUnboundLocalError("offset"); __PYX_ERR(0, 34, __pyx_L1_error) }
  if (unlikely(!__pyx_v_output.memview)) { __Pyx_RaiseUnboundLocalError("output"); __PYX_ERR(0, 34, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_21select_feature_cython_apply_select_features(__pyx_v_input, __pyx_v_offset, __pyx_v_thread, __pyx_v_output, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "select_feature_cython.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "select_feature_cython.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "select_feature_cython.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "select_feature_cython._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"apply_select_features", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_21select_feature_cython_1apply_select_features, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_select_feature_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_select_feature_cython},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initselect_feature_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initselect_feature_cython(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_select_feature_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_select_feature_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_select_feature_cython(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'select_feature_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_select_feature_cython(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("select_feature_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_select_feature_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "select_feature_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "select_feature_cython", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init select_feature_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init select_feature_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_float__const__(PyObject *obj, int writable_flag) {
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_dsdsdsds_int__const__(PyObject *obj, int writable_flag) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
    int axes_specs[] = { (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED), (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED), (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED), (__Pyx_MEMVIEW_DIRECT | __Pyx_MEMVIEW_STRIDED) };
    int retcode;
