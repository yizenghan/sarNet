...
class BasicBlock(nn.Module):
    ...
    def forward_with_mask(self, x):
        ...
        _input_weight_conv1 = self.Gaussian(self.conv1_sigma).reshape((1, 1, self.lg_kernel, self.lg_kernel)).cpu()
        ...
        if VIS:
            visulize(mask_conv1_sigmoid, mask_conv1, out_conv1, out_conv1_interpolate, out_conv1_fusion, name = 'conv1')
        ...
        _input_weight_conv2 = self.Gaussian(self.conv2_sigma).reshape((1, 1, self.lg_kernel, self.lg_kernel)).cpu()
