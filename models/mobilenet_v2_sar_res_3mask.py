...
def mobilenet_v2_width10_sar_res_3mask(args, **kwargs):
...
def mobilenet_v2_width13_sar_res_3mask(args, **kwargs):
...
def mobilenet_v2_width14_sar_res_3mask(args, **kwargs):
...
if __name__ == "__main__":
    ...
    args.alpha = 1
    args.beta = 1
    net = mobilenet_v2_width10_sar_res_3mask(args)
