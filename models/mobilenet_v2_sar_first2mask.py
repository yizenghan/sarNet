...
def mobilenet_v2_width10_sar_first2mask(args, **kwargs):
...
def mobilenet_v2_width13_sar_first2mask(args, **kwargs):
...
def mobilenet_v2_width14_sar_first2mask(args, **kwargs):
...
if __name__ == "__main__":
    ...
    args.alpha = 2
    args.beta = 1
    net = mobilenet_v2_width10_sar_first2mask(args)
