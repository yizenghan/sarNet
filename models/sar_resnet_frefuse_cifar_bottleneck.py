...
def sar_resnetCifar_freFuse(depth, num_classes=100, patch_groups=1, mask_size1=7, mask_size2=2, width=1.0, alpha=1, base_scale=2):
    layers = {
        18: [2,2,2,2],
        34: [3, 4, 6, 3],
        50: [3, 4, 6, 3],
...
def sar_resnet50Cifar100_freFuse_g1a1s2():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=1, mask_size1=4, mask_size2=1, width=1.0, alpha=1, base_scale=2)
def sar_resnet50Cifar100_freFuse_g1a2s2():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=1, mask_size1=4, mask_size2=1, width=1.0, alpha=2, base_scale=2)
def sar_resnet50Cifar100_freFuse_g2a1s2():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=2, mask_size1=4, mask_size2=1, width=1.0, alpha=1, base_scale=2)
def sar_resnet50Cifar100_freFuse_g2a2s2():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=2, mask_size1=4, mask_size2=1, width=1.0, alpha=2, base_scale=2)
def sar_resnet50Cifar100_freFuse_g4a1s2():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=4, mask_size1=4, mask_size2=1, width=1.0, alpha=1, base_scale=2)
def sar_resnet50Cifar100_freFuse_g4a2s2():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=4, mask_size1=4, mask_size2=1, width=1.0, alpha=2, base_scale=2)

def sar_resnet50Cifar100_freFuse_g1a1s4():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=1, mask_size1=4, mask_size2=1, width=1.0, alpha=1, base_scale=4)
def sar_resnet50Cifar100_freFuse_g1a2s4():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=1, mask_size1=4, mask_size2=1, width=1.0, alpha=2, base_scale=4)
def sar_resnet50Cifar100_freFuse_g2a1s4():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=2, mask_size1=4, mask_size2=1, width=1.0, alpha=1, base_scale=4)
def sar_resnet50Cifar100_freFuse_g2a2s4():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=2, mask_size1=4, mask_size2=1, width=1.0, alpha=2, base_scale=4)
def sar_resnet50Cifar100_freFuse_g4a1s4():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=4, mask_size1=4, mask_size2=1, width=1.0, alpha=1, base_scale=4)
def sar_resnet50Cifar100_freFuse_g4a2s4():
    return sar_resnetCifar_freFuse(depth=50, num_classes=100, patch_groups=4, mask_size1=4, mask_size2=1, width=1.0, alpha=2, base_scale=4)
...
if __name__ == "__main__":
    ...
    # print(sar_res)
    sar_res = sar_resnet50Cifar100_freFuse_g4a2s2()
    # with torch.no_grad():
