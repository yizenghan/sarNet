...
parser.add_argument('--use_ls1', type=int, default=1)
parser.add_argument('--use_ls2', type=int, default=1)
parser.add_argument('--use_amp1', type=int, default=1)
parser.add_argument('--use_amp2', type=int, default=1)
parser.add_argument('--warmup1', type=int, default=1)
parser.add_argument('--warmup2', type=int, default=1)

parser.add_argument('--width1', type=float, default=1.0)
parser.add_argument('--width2', type=float, default=1.0)

parser.add_argument('--t0_1', type=float, default=5.0)
parser.add_argument('--t0_2', type=float, default=5.0)
...
parser.add_argument('--temp_scheduler1', default='linear', type=str)
parser.add_argument('--temp_scheduler2', default='linear', type=str)
