...
def multi_thread_run(config='_sarResNet50_g1_blConfig', 
    ...
    train_url = f'{train_url_base}_{sampling_mode}_ls{ls}_amp{use_amp}_warmup{wmup}/'
...
config1 = f'_centerCrop_res50_g1a2_ls_warmup'
config2 = f'_uniform_res50_g1a2_ls_warmup'
