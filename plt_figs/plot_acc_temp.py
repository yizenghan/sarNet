...
fig = plt.figure()
path1_1 = '/home/hanyz/code/sarNet/log/cifar10/sar_resnet32x2_alphaBase_cifar/_round1_optimRate_g2_a2b1_s2/_dynamicRate0_t0_3_0_target0_4_optimizeFromEpoch45to90_lambda_0_5_tempSchedulercosine/log.txt'
res1_1 = pd.read_csv(path1_1)
acc1_1 = np.array(res1_1['train_loss'])[:-1]
rate1_1 = np.array(res1_1['valid_loss'])
rate1_1 = rate1_1[:-1]
...
path1_2 = '/home/hanyz/code/sarNet/log/cifar10/sar_resnet32x2_alphaBase_cifar/_round1_optimRate_g2_a2b1_s2/_dynamicRate0_t0_3_0_target0_25_optimizeFromEpoch45to90_lambda_0_5_tempSchedulercosine/log.txt'
res1_2 = pd.read_csv(path1_2)
acc1_2 = np.array(res1_2['train_loss'])[:-1]
rate1_2 = np.array(res1_2['valid_loss'])[:-1]
...
plt.plot(epochs, rate1_1, c = '#ff3300', label='valid_loss, t0=3.0, 45to90, target=0.4')
plt.plot(epochs, rate1_2, c = '#ff99cc', label='valid_loss, t0=3.0, 45to90, target=0.25')
xlabel(r'$epoch$')
...
plt.plot(epochs, acc1_1, c = '#0066ff', label='train_loss, t0=3.0, target=0.4')
plt.plot(epochs, acc1_2, c = '#33ccff', label='train_loss, t0=3.0, target=0.25')
ylabel(r'$acc1$')
plt.legend(loc=3)
plt.savefig('model3_loss1.png')
