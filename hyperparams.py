...
def get_hyperparams(args, test_code=0):
    if not test_code:
        if args.hyperparams_set_index == 1: # DenseNet Hyperparameters
        ...
        elif args.hyperparams_set_index == 411: # sar-mobilenet-v2
            args.epochs = 200
            args.start_eval_epoch = 0
            args.batch_size = 512
            ### data transform
        ...
        elif args.hyperparams_set_index == 4111: # sar-mobilenet-v2
            args.epochs = 200
            args.start_eval_epoch = 0
            args.batch_size = 512
            ### data transform
            ...
            args.scheduler = 'cosine'
            args.warmup_epoch = 5
            args.warmup_lr = 0.02 # see RegNet pycls/core/config.py _C.OPTIM.WARMUP_FACTOR = 0.1
            ### Mixup
            args.mixup = 0.0
            return args
        
        elif args.hyperparams_set_index == 4177: # sar-mobilenet-v2
            args.epochs = 50
            args.start_eval_epoch = 0
            args.batch_size = 512
            ### data transform
            ...
            args.scheduler = 'cosine'
            args.warmup_epoch = 0
            args.warmup_lr = 0.0 # see RegNet pycls/core/config.py _C.OPTIM.WARMUP_FACTOR = 0.1
            ### Mixup
            args.mixup = 0.0
            return args
        
        elif args.hyperparams_set_index == 4277: # sar-mobilenet-v2
            args.epochs = 50
            args.start_eval_epoch = 0
            args.batch_size = 512
            ### data transform
            ...
            ### optimizer
            args.optimizer = 'SGD'
            args.lr = 0.003*(args.batch_size/256)
            args.momentum = 0.9
            args.weigh_decay_apply_on_all = True  # TODO: weight decay apply on which params
            args.weight_decay = 4e-5
            args.nesterov = True
        ...
        elif args.hyperparams_set_index == 41777: # sar-mobilenet-v2
            args.epochs = 100
            args.start_eval_epoch = 0
            args.batch_size = 512
            ### data transform
        ...
        elif args.hyperparams_set_index == 42777: # sar-mobilenet-v2
            args.epochs = 100
            args.start_eval_epoch = 0
            args.batch_size = 512
            ### data transform
        ...
        elif args.hyperparams_set_index == 43777: # sar-mobilenet-v2
            args.epochs = 200
            args.start_eval_epoch = 0
            args.batch_size = 512
            ### data transform
        ...
        elif args.hyperparams_set_index == 43778: # sar-mobilenet-v2
            args.epochs = 200
            args.start_eval_epoch = 0
            args.batch_size = 1024
            ### data transform
        ...
        elif args.hyperparams_set_index == 4122: # sar-mobilenet-v2
            args.epochs = 300
            args.start_eval_epoch = 0
            args.batch_size = 1024
            ### data transform
        ...
        elif args.hyperparams_set_index == 23333: # sarResNet, use label smooth, wmup
            args.epochs = 90
            args.start_eval_epoch = 0
            args.batch_size = 256
            ### data transform
        ...
        elif args.hyperparams_set_index == 2330: # sarResNet, use label smooth, wmup
            args.epochs = 200
            args.start_eval_epoch = 0
            args.batch_size = 256*2
            ### data transform
            ...
            args.scheduler = 'cosine'
            args.warmup_epoch = 5
            args.warmup_lr = args.lr/4
            ### Mixup
            args.mixup = 0.0
            return args

        elif args.hyperparams_set_index == 23300: # sarResNet, use label smooth, wmup
            args.epochs = 200
            args.start_eval_epoch = 0
            args.batch_size = 256*4
            ### data transform
        ...
        elif args.hyperparams_set_index == 23377: # sarResNet, use label smooth, wmup
            args.epochs = 300
            args.start_eval_epoch = 0
            args.batch_size = 256*4
            ### data transform
        ...
        elif args.hyperparams_set_index == 2331: # sarResNet, use label smooth, wmup
            args.epochs = 200
            args.start_eval_epoch = 0
            args.batch_size = 256
            ### data transform
        ...
        elif args.hyperparams_set_index == 3023: # sarResNet, use label smooth, wmup
            args.epochs = 110
            args.start_eval_epoch = 0
            args.batch_size = 256*2
            ### data transform
        ...
        elif args.hyperparams_set_index == 3024: # sarResNet, use label smooth, wmup
            args.epochs = 110
            args.start_eval_epoch = 0
            args.batch_size = 64
            ### data transform
        ...
        elif args.hyperparams_set_index == 234: # sarResNet, no label smooth, wmup
            args.epochs = 110
            args.start_eval_epoch = 0
            args.batch_size = 256*4
            ### data transform
