...
--data_url /home/share/imagenet/ \
--train_url 'log/' \
--resume log/_ImageNet/sar_resnet34_alphaBase_4stage_imgnet_OptimRate/g2_a2b1_s2/t0_5_0_tLast0_01_tempScheduler_exp_target0_75_optimizeFromEpoch0to55_dr3_lambda_0_2/checkpoint.pth.tar \
